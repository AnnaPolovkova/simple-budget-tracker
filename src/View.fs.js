...
export function view(model, dispatch) {
    let elems_15, elms_2, elms_1, xs_57, elems_12, xs_40, elems_6, xs_5, elems, xs_1, xs_18, elems_2, xs_9, xs_14, elems_1, xs_31, elems_4, xs_22, xs_27, elems_3, elms, xs_35, elems_8, xs_44, elems_7, children_3, children_1, children_5, elems_9, elems_11, xs_52, elems_10;
    const xs_63 = ofArray([["style", {
        backgroundImage: "linear-gradient(135deg, #6633DD 0%, #C8C1F4 100%)",
        minHeight: 100 + "vh",
        paddingTop: 20,
    }], (elems_15 = [(elms_2 = singleton((elms_1 = singleton((xs_57 = ofArray([["style", {
        boxShadow: "none",
        borderRadius: 15,
        backgroundColor: "white",
        padding: 20,
    }], (elems_12 = [createElement("h1", {
        ...
        const v = tupledArg[0];
        return v === "className";
    }, map((value_39) => value_39, xs_1)))))]))))))))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems))])]), createElement("div", createObj(toList(delay(() => append(xs_5, delay(() => singleton_1(["className", join(" ", append_1(singleton("control"), map((arg_1) => toString_1(arg_1[1]), filter((tupledArg_1) => {
        const v_1 = tupledArg_1[0];
        return v_1 === "className";
    }, map((value_42) => value_42, xs_5)))))])))))))), (xs_18 = ofArray([["className", "has-icons-left"], (elems_2 = [(xs_9 = ofArray([["placeholder", "0.00"], ["value", model.InputAmount], ["onChange", (ev_1) => {
    ...
    }, map((value_56) => value_56, xs_9)))))])))))))))), (xs_14 = ofArray([["className", "is-left"], (elems_1 = [createElement("i", {
    ...
    }, map((value_63) => value_63, xs_14)))))]))))))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_2))])]), createElement("div", createObj(toList(delay(() => append(xs_18, delay(() => singleton_1(["className", join(" ", append_1(singleton("control"), map((arg_4) => toString_1(arg_4[1]), filter((tupledArg_4) => {
        const v_4 = tupledArg_4[0];
        return v_4 === "className";
    }, map((value_66) => value_66, xs_18)))))])))))))), (xs_31 = ofArray([["className", "has-icons-left"], (elems_4 = [(xs_22 = ofArray([["placeholder", "Category"], ["value", model.InputCategory], ["onChange", (ev_2) => {
    ...
    }, map((value_80) => value_80, xs_22)))))])))))))))), (xs_27 = ofArray([["className", "is-left"], (elems_3 = [createElement("i", {
    ...
    }, map((value_87) => value_87, xs_27)))))]))))))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_4))])]), createElement("div", createObj(toList(delay(() => append(xs_31, delay(() => singleton_1(["className", join(" ", append_1(singleton("control"), map((arg_7) => toString_1(arg_7[1]), filter((tupledArg_7) => {
        const v_7 = tupledArg_7[0];
        return v_7 === "className";
    }, map((value_90) => value_90, xs_31)))))])))))))), (elms = singleton((xs_35 = ofArray([["className", "is-primary"], ["style", {
    ...
    }, map((value_102) => value_102, xs_35)))))]))))))))), createElement("div", {
        className: "control",
    ...
    }, map((value_108) => value_108, xs_40)))))])))))))), createElement("div", createObj(ofArray([["className", "table-container"], ["style", {
        marginBottom: 30,
    }], (elems_8 = [(xs_44 = ofArray([["className", "is-fullwidth"], ["className", "is-striped"], ["className", "is-hoverable"], ["style", {
        borderRadius: 10,
        boxShadow: "none",
    ...
    }, map((value_131) => value_131, xs_44)))))]))))))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_8))])]))), createElement("div", createObj(ofArray([["style", {
        marginBottom: 30,
        padding: 20,
        backgroundColor: "#f9f9f9",
        borderRadius: 10,
    }], (elems_9 = [createElement("h3", {
    ...
    }), categoryPieChart(model.Transactions)], ["children", Interop_reactApi.Children.toArray(Array.from(elems_9))])]))), createElement("div", createObj(ofArray([["className", "has-text-centered"], ["style", {
        marginTop: 20,
    }], (elems_11 = [(xs_52 = ofArray([["className", "is-medium"], ["style", {
        backgroundColor: "#C8C1F4",
        color: "#2E2E2E",
        padding: ((15 + "px ") + 25) + "px",
        fontSize: 16 + "px",
        ...
        const color_12 = (compare(total, fromParts(0, 0, 0, false, 0)) >= 0) ? "has-text-success" : "has-text-danger";
        return singleton_1(createElement("span", {
            className: color_12,
            children: (clo = toText(printf("Total Balance: $%.2f")), clo(total)),
        }));
    })), ["children", Interop_reactApi.Children.toArray(Array.from(elems_10))])]), createElement("span", createObj(toList(delay(() => append(xs_52, delay(() => singleton_1(["className", join(" ", append_1(singleton("tag"), map((arg_12) => toString_1(arg_12[1]), filter((tupledArg_11) => {
        const v_11 = tupledArg_11[0];
        return v_11 === "className";
    }, map((value_167) => value_167, xs_52)))))]))))))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_11))])])))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_12))])]), createElement("div", createObj(toList(delay(() => append(xs_57, delay(() => singleton_1(["className", join(" ", append_1(singleton("box"), map((arg_13) => toString_1(arg_13[1]), filter((tupledArg_12) => {
        const v_12 = tupledArg_12[0];
        return v_12 === "className";
    }, map((value_171) => value_171, xs_57)))))]))))))))), createElement("div", {
        className: "container",
    ...
    return createElement("section", createObj(toList(delay(() => append(xs_63, delay(() => singleton_1(["className", join(" ", append_1(singleton("hero"), map((arg_14) => toString_1(arg_14[1]), filter((tupledArg_13) => {
        const v_13 = tupledArg_13[0];
        return v_13 === "className";
    }, map((value_180) => value_180, xs_63)))))])))))));
}
